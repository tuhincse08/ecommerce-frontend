...
const data =[
    { id:0, img:"/product__5.webp", name:"Fresh Tomato", price:5 },
...
function Breakfastsection() {
  return (
    <div className="container pt-16">
        ...
        <div>
            <h3 className="text-2xl">Breakfast & Dairy</h3>
            <div className="text-lg text-gray-600">Buy best quality breakfast online from big-basket stop near you.</div>
        </div>
